...
<div id="cards" class="content-section">
  <div class="card-box dynamic-section">
    <h3>Available RX Medo Cards</h3>
    <p>You can select the card that suits your needs:</p>

    <div class="card-grid">
      <!-- 1. RX Medo Card -->
      <div class="card-item">
        <h4>RX Medo Card</h4>
        <p>For: Individual | No age limit</p>
        <p>Features: Basic RX Medo benefits</p>
        <p>Price: ₹3,000</p>
        <button onclick="showServices('rxmedo')" class="view-btn">View Services</button>
      </div>

      <!-- 2. RX Medo Family Card -->
      <div class="card-item">
        <h4>RX Medo Family Card</h4>
        <p>For: Family (up to 4 members)</p>
        <p>Features: All RX Medo benefits for family</p>
        <p>Price: ₹8,000</p>
        <button onclick="showServices('family')" class="view-btn">View Services</button>
      </div>

      <!-- 3. RX Medo YoungShield Card -->
      <div class="card-item">
        <h4>RX Medo YoungShield Card</h4>
        <p>For: Age 18–35</p>
        <p>Features: ₹5 Lakh insurance + pre-existing cover</p>
        <p>Price: ₹8,000</p>
        <button onclick="showServices('youngshield')" class="view-btn">View Services</button>
      </div>

      <!-- 4. RX Medo CitizenCare Card -->
      <div class="card-item">
        <h4>RX Medo CitizenCare Card</h4>
        <p>For: Age 36–45</p>
        <p>Features: ₹5 Lakh insurance + pre-existing cover</p>
        <p>Price: ₹10,000</p>
        <button onclick="showServices('citizencare')" class="view-btn">View Services</button>
      </div>

      <!-- 5. RX Medo GuardianCare Card -->
      <div class="card-item">
        <h4>RX Medo GuardianCare Card</h4>
        <p>For: Age 46–55</p>
        <p>Features: ₹5 Lakh insurance + pre-existing cover</p>
        <p>Price: ₹15,000</p>
        <button onclick="showServices('guardiancare')" class="view-btn">View Services</button>
      </div>

      <!-- 6. RX Medo SeniorShield Card -->
      <div class="card-item">
        <h4>RX Medo SeniorShield Card</h4>
        <p>For: Age 56–65</p>
        <p>Features: ₹5 Lakh insurance + pre-existing cover</p>
        <p>Price: ₹25,000</p>
        <button onclick="showServices('seniorshield')" class="view-btn">View Services</button>
      </div>

      <!-- 7. RX Medo FamilySecure Card -->
      <div class="card-item">
        <h4>RX Medo FamilySecure Card</h4>
        <p>For: Family (max age 35)</p>
        <p>Features: ₹5 Lakh insurance + covers spouse & 4 children</p>
        <p>Price: ₹15,000</p>
        <button onclick="showServices('familysecure')" class="view-btn">View Services</button>
      </div>

      <!-- 8. RX Medo Top-Up Card -->
      <div class="card-item">
        <h4>RX Medo Top-Up Card</h4>
        <p>For: Individual | No age limit</p>
        <p>Features: ₹40 Lakh top-up for existing insurance holders</p>
        <p>Price: Starts from ₹3,500</p>
        <button onclick="showServices('topup')" class="view-btn">View Services</button>
      </div>

      <!-- 9. RX Medo Family Top-Up Card -->
      <div class="card-item">
        <h4>RX Medo Family Top-Up Card</h4>
        <p>For: Family | No age limit</p>
        <p>Features: ₹40 Lakh top-up extended to 4 members</p>
        <p>Price: Starts from ₹4,000</p>
        <button onclick="showServices('familytopup')" class="view-btn">View Services</button>
      </div>
    </div>
      ...
      <div style="display: flex;gap: 10px;margin-top: 40px;" class="hsp">
        ...
        <div class="hospital-cards-container row g-4">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hospital-card">
              <div class="hospital-card-img-container">
                <img src="srs" alt="Shri Ram Singh Hospital" class="hospital-card-img">
                <div class="hospital-card-overlay"></div>
                <!--<div class="hospital-card-rating">-->
                <!--  <i class="bi bi-star-fill"></i> -->
                <!--</div>-->
              ...
              <div class="hospital-card-content">
                ...
                <div class="hospital-card-location">
                  <i class="bi bi-geo-alt-fill"></i>Shri Ram Singh MultiSpeciality Hospital, Opp. OIDB, Sector 70, Noida (Uttar Pradesh) INDIA
                </div>
                <p class="hospital-card-description">
                  Comprehensive healthcare services with modern infrastructure and support.
                </p>
                ...
                <a href="https://www.google.com/search?q=srs+hospital+noida+sector+70+location&oq=srs+hospital+noida+sector+70+location&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIHCAEQIRigATIHCAIQIRigATIHCAMQIRiPAtIBCTIwMzEwajBqN6gCCLACAfEF5PkbndY6zKQ&sourceid=chrome&ie=UTF-8" target="_blank"
                  class="hospital-card-btn">
                  View Location <i class="bi bi-arrow-right"></i>
                </a>
              </div>
    ...
    <div id="pharmacy" class="content-section">
      ...
      <section class="recommended">
        ...
        <div class="hospital-grid">
          ...
          <!-- aman medical -->
          <div class="hospital-box">
            <img style="height: 250px;" src="https://pbs.twimg.com/profile_images/1229372089821532160/YP19Pql2.jpg" alt="Aman medical" />
            <h3>Aman Medical</h3>
            <!--<p><b>Address:</b> Sector 137, Noida, Uttar Pradesh 201305</p>-->
            <p>Comprehensive healthcare services with modern Pharmacy facilities and experienced doctors.</p>
            <!--<div class="offer">💰 20% OFF on Pharmacy</div>-->
          ...
          <!-- careplus pharmacy -->
          <div class="hospital-box">
            <img style="height: 250px;" src="careplus.jpeg" alt="Felix Hospital" />
          ...
          <!-- rxhealthphrmacy -->
          <div class="hospital-box">
            <img style="height: 250px;" src="Rx healthcare pharmacy.png" alt="Rx Health pharmacy" />
  ...
  <!-- ✅ action set to PHP file, method POST, enctype for file upload -->
  <form id="opdForm" action="submit_pharmacy.php" method="POST" enctype="multipart/form-data">
    ...
    <textarea name="description" rows="3" placeholder="Description of receipt or upload directly above"></textarea>
      ...
      <section class="recommended">
        ...
        <div class="hospital-grid">
          ...
          <div class="hospital-box">
           ...
           <!--SRS-->
          <div class="hospital-box" style="">
            <img style="height: 250px;" src="srs" alt="SRS  Hospital" />
            <h3>Shri Ram Singh Hospital</h3>
            <p><b>Address:</b> Shri Ram Singh MultiSpeciality Hospital, Opp. OIDB, Sector 70, Noida (Uttar Pradesh) INDIA</p>
            <p>Comprehensive healthcare services with modern OPD facilities and experienced doctors.</p>
            <div class="offer">💰upto 20% Discount on OPD</div>
          </div>
          
          <!--max-->
          <div class="hospital-box" style="">
            <img style="height: 250px;" src="./images/max.webp" alt="Max  Hospital" />
            <h3>Max Hospital</h3>
            <p><b>Address:</b> Vaishali,Ghaziabad,Uttar Pradesh India</p>
            <p>Comprehensive healthcare services with modern OPD facilities and experienced doctors.</p>
            <div class="offer">💰upto 20% Discount on OPD</div>
          </div>
          ...
          <!--medima-->
         <div class="hospital-box">
            <img style="height: 250px;" src="medimalogo" alt="Medima Center" />
            <h3>Medimaa Imaging Center</h3>
            <p><b>Address:</b> Kh no 433 , Ground Floor, Ramshree complex, near Shivalik hospital, Sector 51, Noida, Uttar Pradesh 201301</p>
            <p>Comprehensive healthcare services with modern Diagnostic facilities and experienced doctors.</p>
          ...
          <!--appolo-->
          <div class="hospital-box">
            <img style="height: 250px;" src="https://cdn.siasat.com/wp-content/uploads/2021/08/photo_2021-08-28_16-08-26.jpg" alt="Felix Hospital" />
          ...
          <!-- cureleo -->
          <div class="hospital-box">
            <img style="height: 250px;" src="https://images.crunchbase.com/image/upload/c_pad,h_256,w_256,f_auto,q_auto:eco,dpr_1/qrrh7az1avfxkqmlhxxn" alt="Felix Hospital" />
            <h3>curelo Diagnostics</h3>
            <!--<p><b>Address:</b> Sector 137, Noida, Uttar Pradesh 201305</p>-->
            <p>Comprehensive healthcare services with modern Diagnostic facilities and experienced doctors.</p>
            <div class="offer">💰 15% Discount on Diagnostic</div>
          </div>
          ...
          <!-- star -->
          <div class="hospital-box">
            <img style="height: 250px;" src="STAR RADIOLOGY.png" alt="Felix Hospital" />
          ...
          <!-- Redcliffe -->
          <div class="hospital-box">
            <img style="height: 250px;" src="redclif.jpeg" alt="Redcliff Lab" />
            <h3>Redcliffe Lab</h3>
            <!--<p><b>Address:</b> Sector 137, Noida, Uttar Pradesh 201305</p>-->
            <p>Comprehensive healthcare services with modern Diagnostic facilities and experienced doctors.</p>
            <div class="offer">💰 15% Discount on Diagnostic</div>
           ...
           <!-- Fusions -->
          <div class="hospital-box">
            <img style="height: 250px;" src="fusion.jpeg" alt="Redcliff Lab" />

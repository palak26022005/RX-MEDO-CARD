      ...
      <div class="form-container">
        ...
        <form method="POST" action="submit_request.php" enctype="multipart/form-data">
          ...
          <div id="hospital_block">
            ...
            <div class="dropdown">
              <div class="dropdown-btn" id="dropdownBtn">-- Select Hospital --</div>
              <div class="dropdown-content" id="dropdownContent">
                <div class="dropdown-header">
                  <input type="text" id="hospital_search" placeholder="Search hospitals...">
                </div>
  ...
  <script>
    ...
    serviceTypeSelect.addEventListener('change', function () {
      ...
      if (selectedType === 'Pharmacy') {
        ...
        dropdownBtn.textContent = "-- Select Hospital --";
